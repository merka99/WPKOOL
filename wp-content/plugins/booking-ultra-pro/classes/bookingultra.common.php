...
class BookingUltraCommon
{
    ...
    {
		global  $bookingultrapro;
		$date_format = $bookingultrapro->get_option('bup_date_format');
        ...
        switch ($type) {
            ...
            case 'textarea':
              ...
              /*  print "<textarea name=\"$id\" type=\"text\" id=\"$id\" class=\"large-text code text-area uultra-setting-options-texarea\" rows=\"3\">$value</textarea>";*/
				...
				$html = $bookingultrapro->userpanel->get_me_wphtml_editor($id, $value);
...
$key = "commmonmethods";
$this->{$key} = new BookingUltraCommon();
?>