...
if( !class_exists( 'CPAPPB_iCalExport' ) )
{
    class CPAPPB_iCalExport extends CPAPPB_BaseAddon
    {
			...
			<div id="metabox_basic_settings" class="postbox" >
				...
				<div class="inside">
                   ...
                   <table class="form-table">
                    <tr valign="top">
                    <th scope="row"><?php _e('iCal timezone difference vs server time', 'cpappb'); ?></th>
                    ...
                    <tr valign="top">
                    <th scope="row"><?php _e('Observe daylight saving time?', 'cpappb'); ?></th>
                    ...
                    <tr valign="top">
                    <th scope="row"><?php _e('Daylight saving time zone', 'cpappb'); ?></th>
                    ...
                    <tr valign="top">
                    <th scope="row"><?php _e('Attach iCal file to notification emails?', 'cpappb'); ?></th>
                    ...
                    <tr valign="top">
                    <th scope="row"><?php _e('iCal entry summary', 'cpappb'); ?></th>
                    ...
                    <tr valign="top">
                    <th scope="row"><?php _e('iCal entry description', 'cpappb'); ?></th>
        ...
        {
			$this->description = __("The add-on adds support for exporting iCal files.", 'cpappb' );
