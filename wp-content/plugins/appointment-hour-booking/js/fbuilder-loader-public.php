...
?>
        var fcount = 1;
        var fnum = "_"+fcount;
        while (eval("typeof cp_appbooking_fbuilder_config"+fnum+" != 'undefined'"))
        {
            try {
            var cp_appbooking_fbuilder_config = eval("cp_appbooking_fbuilder_config"+fnum);
            var f = $("#fbuilder"+fnum).fbuilder($.parseJSON(cp_appbooking_fbuilder_config.obj));
			f.fBuild.loadData("form_structure"+fnum);
			$("#cp_appbooking_pform"+fnum).validate({
