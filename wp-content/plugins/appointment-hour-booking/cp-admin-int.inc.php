...
<div class="ahb-adintsection-container">
    ...
    <div class="ahb-adintsection ahb-adintsection-active" data-step="1">
      ...
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Button Labels','cpappb'); ?></span></h3>
      <div class="inside">
      ...
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Error messages for validation rules','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
            <td scope="row">
     ...
     <div class="ahb-adintsection" data-step="2">
      ...
      <div class="inside">
         ...
         <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Confirmation / Thank you page','cpappb'); ?></span></h3>
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Confirmation / Thank you page','cpappb'); ?></th>
         ...
         <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Booking Status','cpappb'); ?></span></h3>
         <table class="form-table">
            <tr valign="top">
            <th scope="row"><?php _e('Default status of new bookings','cpappb'); ?></th>
            ...
            <tr valign="top">
            <th scope="row"><?php _e('Default status of paid bookings','cpappb'); ?></th>
         ...
         <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Global Calendar Settings','cpappb'); ?></span></h3> 
         <table class="form-table">
            <tr valign="top">
    ...
    <option <?php if ($v == 'cy_GB') echo 'selected'; ?> value="cy_GB">Welsh/UK</option>
      ...
      <hr />
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Payment Integration Settings','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
      ...
      <hr />
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Users with access to the messages list','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
     ...
     <div class="ahb-adintsection" data-step="3">
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('From / To Email Addresses','cpappb'); ?>:</span></h3>
      <div class="inside">
         <table class="form-table">
            ...
            <hr />
            <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Email Notification to Website Administrator','cpappb'); ?>:</span></h3>
      ...
      <hr />
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Email Copy to the User / Customer','cpappb'); ?>:</span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
     ...
     <div class="ahb-adintsection" data-step="4">
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Captcha Verification','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
     ...
     <div class="ahb-adintsection" data-step="5">
      <h3 class='hndle' style="padding-top:5px;padding-bottom:5px;"><span><?php _e('Automatic Reports: Send submissions in CSV format via email','cpappb'); ?></span></h3>
      <div class="inside">
         <table class="form-table">
            <tr valign="top">
